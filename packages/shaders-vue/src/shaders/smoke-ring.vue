...
const props = defineProps<SmokeRingProps>();

const uniforms = computed<SmokeRingUniforms>(() => {
  return {
...
<template>
  <ShaderMount v-bind="props" :fragment-shader="smokeRingFragmentShader" :uniforms />
</template>
