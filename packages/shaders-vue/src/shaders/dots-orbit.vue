...
const props = defineProps<DotsOrbitProps>();

const uniforms = computed<DotsOrbitUniforms>(() => {
  return {
...
<template>
  <ShaderMount v-bind="props" :fragment-shader="dotsOrbitFragmentShader" :uniforms />
</template>
