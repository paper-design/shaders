...
const props = defineProps<NeuroNoiseProps>();

const uniforms = computed<NeuroNoiseUniforms>(() => {
  return {
...
<template>
  <ShaderMount v-bind="props" :fragment-shader="neuroNoiseFragmentShader" :uniforms />
</template>
