...
export { ImageLiquidMetal, imageLiquidMetalPresets } from './shaders/image-liquid-metal.js';
export type { ImageLiquidMetalProps } from './shaders/image-liquid-metal.js';
export type { ImageLiquidMetalUniforms, ImageLiquidMetalParams } from '@paper-design/shaders';
