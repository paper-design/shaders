...
export const PaperTexture: React.FC<PaperTextureProps> = memo(function PaperTextureImpl({
  ...
  creaseSize = defaultPreset.params.creaseSize,
  creaseCross = defaultPreset.params.creaseCross,
  creaseOffset = defaultPreset.params.creaseOffset,
  ...
  const uniforms = {
    ...
    u_creaseSize: creaseSize,
    u_creaseCross: creaseCross,
    u_creaseOffset: creaseOffset,
    u_folds: folds,
    u_creases: creases,
    u_fade: fade,
    u_drops: drops,
