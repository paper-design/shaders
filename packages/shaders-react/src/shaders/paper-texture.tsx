...
export const PaperTexture: React.FC<PaperTextureProps> = memo(function PaperTextureImpl({
  ...
  crumpleSoftness = defaultPreset.params.crumpleSoftness,
  test = defaultPreset.params.test,
  testSize = defaultPreset.params.testSize,
  testLayers = defaultPreset.params.testLayers,
  testDensity = defaultPreset.params.testDensity,
  testSoftness = defaultPreset.params.testSoftness,
  ...
  const uniforms = {
    ...
    u_crumpleSoftness: crumpleSoftness,
    ...
    u_test: test,
    u_testSize: testSize,
    u_testLayers: testLayers,
    u_testDensity: testDensity,
    u_testSoftness: testSoftness,
    u_folds: folds,
    u_drops: drops,
    u_seed: seed,
    u_blending: blending,
