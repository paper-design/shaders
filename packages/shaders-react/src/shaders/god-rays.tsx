...
export const defaultPreset: GodRaysPreset = {
  name: 'Default',
  params: {
    colorBack: 'hsla(208, 25%, 48%, 1)',
    color1: 'hsla(45, 100%, 83%, 1)',
    color2: 'hsla(318, 25%, 48%, 1)',
...
export const preset1: GodRaysPreset = {
  ...
  params: {
    ...
    color1: 'hsla(196, 100%, 65%, 1)',
    color2: 'hsla(90, 64%, 63%, 1)',
    color3: 'hsla(0, 100%, 50%, 1)',
    offsetX: 0,
    offsetY: 1,
    spotty: 0.45,
    midIntensity: 0.97,
