...
export const defaultPreset: GrainGradientPreset = {
  ...
  params: {
    ...
    colors: ['hsla(32, 89%, 40%, 1)', 'hsla(46, 60%, 60%, 1)', 'hsla(39, 28%, 81%, 1)'],
    softness: 0.35,
...
export const dotsPreset: GrainGradientPreset = {
  ...
  params: {
    ...
    colors: ['hsla(0, 100%, 22%, 1)', 'hsla(210, 85%, 69%, 1)', 'hsla(48, 52%, 90%, 1)'],
    softness: 0.5,
    grainDistortion: 0.15,
    sandGrain: 0.5,
    shape: 2,
...
export const truchetPreset: GrainGradientPreset = {
  ...
  params: {
    ...
    frame: 0,
    colorBack: 'hsla(0, 100%, 2%, 1)',
    colors: ['hsla(24, 100%, 22%, 1)', 'hsla(35, 85%, 69%, 1)', 'hsla(100, 52%, 45%, 1)'],
    softness: 0,
    grainDistortion: 0.15,
    sandGrain: 0.5,
    shape: 3,
...
export const cornersPreset: GrainGradientPreset = {
  ...
  params: {
    ...
    colors: ['hsla(200, 100%, 40%, 1)', 'hsla(170, 100%, 50%, 1)', 'hsla(50, 100%, 50%, 1)'],
    softness: 0.2,
...
export const ripplePreset: GrainGradientPreset = {
  ...
  params: {
    ...
    colors: ['hsla(25, 100%, 22%, 1)', 'hsla(140, 70%, 70%, 1)', 'hsla(4305, 64%, 11%, 1)'],
    softness: 1,
    grainDistortion: 1,
    sandGrain: 0.5,
    shape: 5,
...
export const blobPreset: GrainGradientPreset = {
  ...
  params: {
    ...
    colors: ['hsla(200, 30%, 35%, 1)', 'hsla(50, 30%, 55%, 1)', 'hsla(90, 25%, 45%, 1)'],
    softness: 0,
    grainDistortion: 0.15,
    sandGrain: 0.5,
    shape: 6,
...
export const spherePreset: GrainGradientPreset = {
  ...
  params: {
    ...
    colors: ['hsla(210, 100%, 35%, 1)', 'hsla(180, 95%, 60%, 1)', 'hsla(130, 80%, 45%, 1)'],
    softness: 1,
    grainDistortion: 0.15,
    sandGrain: 0.5,
    shape: 7,
