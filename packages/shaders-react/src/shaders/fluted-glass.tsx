...
export const FlutedGlass: React.FC<FlutedGlassProps> = memo(function FlutedGlassImpl({
  ...
  colorShadows = defaultPreset.params.colorShadows,
  colorHighlights = defaultPreset.params.colorHighlights,
  image = '',
  ...
  const uniforms = {
    ...
    u_colorShadows: getShaderColorFromString(colorShadows),
    u_colorHighlights: getShaderColorFromString(colorHighlights),
    u_shadows: shadows,
    u_size: size,
    u_angle: angle,
