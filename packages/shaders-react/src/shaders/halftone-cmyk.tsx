...
export const posterizedPreset: HalftoneCmykPreset = {
  name: 'Posterized',
  params: {
    ...defaultObjectSizing,
    scale: 0.8,
...
export const halftoneCmykPresets: HalftoneCmykPreset[] = [defaultPreset, dropsPreset, newspaper, posterizedPreset];
