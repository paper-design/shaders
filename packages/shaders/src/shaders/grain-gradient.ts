 ...
 * - v_objectUV (vec2): Normalized UV coordinates with scale, rotation, and offset applied (used for shapes 4-7)
 * - v_objectBoxSize (vec2): Size of the object bounding box in pixels
 * - v_patternUV (vec2): UV coordinates in CSS pixels (scaled by 0.01 for precision), with rotation and offset applied (used for shapes 1-3)
