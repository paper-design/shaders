...
import { PerlinNoiseWithControls } from './shaders/perlin-noise-example';
      ...
      <Switch>
        <Route path="/">
          ...
          <ul>
            ...
            <li>
              <Link href="/perlin-noise">Perlin Noise</Link>
            </li>
          </ul>
        </Route>
        ...
        <Route path="/perlin-noise" component={PerlinNoiseWithControls} />
      </Switch>
    </Router>
  );
};
