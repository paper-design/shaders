...
export const homeShaders = [
  {
    ...
    shaderConfig: { ...grainGradientPresets[0].params, speed: 0 },
  },
  {
    name: 'mesh gradient',
    ...
    shaderConfig: { ...meshGradientPresets[0].params, speed: 0 },
  },
  {
    ...
    shaderConfig: { ...staticMeshGradientPresets[0].params, speed: 0 },
  },
  {
    ...
    shaderConfig: { ...staticRadialGradientPresets[0].params, speed: 0 },
  },
  {
    name: 'dithering',
    url: '/dithering',
    ...
    image: ditheringImg,
    shaderConfig: { ...ditheringPresets[4].params, speed: 0 },
  },
  {
    name: 'dot orbit',
    image: dotOrbitImg,
    ...
    shaderConfig: { ...dotOrbitPresets[0].params, speed: 0 },
  },
  {
    name: 'dot grid',
    url: '/dot-grid',
  ...
  },
  {
    ...
    image: warpImg,
    shaderConfig: { ...warpPresets[0].params, speed: 0 },
  },
  {
    name: 'spiral',
    url: '/spiral',
    ...
    image: spiralImg,
    shaderConfig: { ...spiralPresets[0].params, speed: 0 },
  },
  {
    name: 'swirl',
    url: '/swirl',
    ...
    image: swirlImg,
    shaderConfig: { ...swirlPresets[0].params, speed: 0 },
  },
  {
    name: 'waves',
    url: '/waves',
    ...
    image: wavesImg,
    shaderConfig: { ...wavesPresets[0].params, speed: 0 },
  },
  {
    name: 'neuro noise',
    image: neuroNoiseImg,
    ...
    shaderConfig: { ...neuroNoisePresets[0].params, speed: 0 },
  },
  {
    name: 'perlin',
    url: '/perlin-noise',
    ...
    shaderConfig: { ...perlinNoisePresets[0].params, speed: 0 },
  },
  {
    name: 'simplex noise',
    ...
    shaderConfig: { ...simplexNoisePresets[0].params, speed: 0 },
  },
  {
    name: 'voronoi',
    url: '/voronoi',
    ...
    image: voronoiImg,
    shaderConfig: { ...voronoiPresets[0].params, speed: 0 },
  },
  {
    name: 'pulsing border',
    url: '/pulsing-border',
    ...
    shaderConfig: { ...pulsingBorderPresets[0].params, speed: 0 },
  },
  {
    name: 'metaballs',
    image: metaballsImg,
    ...
    shaderConfig: { ...metaballsPresets[0].params, speed: 0 },
  },
  {
    name: 'color panels',
    url: '/color-panels',
    ...
    shaderConfig: { ...colorPanelsPresets[0].params, speed: 0 },
  },
  {
    name: 'smoke ring',
    image: smokeRingImg,
    ...
    shaderConfig: { ...smokeRingPresets[0].params, speed: 0 },
  },
  {
    name: 'liquid metal',
    url: '/liquid-metal',
    ...
    shaderConfig: { ...liquidMetalPresets[0].params, speed: 0 },
  },
  {
    name: 'god rays',
    url: '/god-rays',
    ...
    image: godRaysImg,
    shaderConfig: { ...godRaysPresets[0].params, speed: 0 },
  },
  {
    name: 'paper texture',
    url: '/paper-texture',
    ...
    shaderConfig: { ...paperTexturePresets[0].params, speed: 0 },
  },
  {
    name: 'fluted glass',
    url: '/fluted-glass',
    ...
    shaderConfig: { ...flutedGlassPresets[0].params, speed: 0 },
  },
  {
    ...
    shaderConfig: { ...imageDitheringPresets[1].params, speed: 0 },
  },
  {
    name: 'water',
    url: '/water',
    ...
    image: waterImg,
    shaderConfig: { ...waterPresets[0].params, speed: 0 },
  },
