...
export const dotOrbitDef: ShaderDef = {
  name: 'Dot Orbit',
  description:
    'Animated multi-color dots pattern with each dot orbiting around its cell center. Supports up to (4 x 10) colors, shape and motion controls. Great for playful, dynamic backgrounds and UI textures.',
  params: [
    {
      name: 'colors',
      type: 'string[]',
