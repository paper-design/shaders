      ...
      Parameters: folder(
        {
          ...
          color3: { value: defaults.color3, order: 103 },
            size: { value: defaults.size, min: 0, max: 200, order: 200 },
          power: { value: defaults.power, min: 0, max: 3, order: 201 },
            pulse: {value: defaults.pulse, min: 0, max: 1, order: 203},
            frequency: { value: defaults.frequency, min: 0, max: 10, order: 206 },
          borderLine: { value: defaults.borderLine, min: 0, max: 1, order: 206 },
          inner: { value: defaults.inner, min: 0, max: 1, order: 206 },
