...
export const homeShaders = [
  ...
  },
  {
    ...
    shaderConfig: { ...staticRadialGradientPresets[0].params, radius: 0.9 },
  },
  {
    name: 'dithering',
    url: '/dithering',
  ...
  },
  {
    ...
    shaderConfig: { ...pulsingBorderPresets[0].params, scale: 0.8 },
  },
  {
    name: 'metaballs',
    image: metaballsImg,
  ...
  },
  {
    ...
    shaderConfig: { ...colorPanelsPresets[0].params, scale: 0.8, speed: 3, rotation: 100 },
  },
  {
    name: 'smoke ring',
    image: smokeRingImg,
    ...
    shaderConfig: { ...smokeRingPresets[0].params, scale: 1, speed: 2 },
  },
  {
    name: 'liquid metal',
    url: '/liquid-metal',
    ...
    shaderConfig: { ...liquidMetalPresets[0].params, scale: 0.9 },
  },
  {
    name: 'god rays',
    url: '/god-rays',
