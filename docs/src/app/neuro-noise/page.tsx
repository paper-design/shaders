...
const NeuroNoiseWithControls = () => {
  const [params, setParams] = useControls(() => {
    ...
    return {
      Parameters: folder(
        {
          colorTest: { value: defaults.colorFront, order: 99 },
          colorFront: { value: defaults.colorFront, order: 100 },
          colorBack: { value: defaults.colorBack, order: 101 },
          brightness: { value: defaults.brightness, min: 0, max: 2, order: 300 },
          depth: { value: defaults.depth, min: 0, max: 1, order: 301 },
