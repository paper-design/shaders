      ...
      Parameters: folder(
        {
          ...
          scale: { value: defaults.scale, min: 0, max: 5, order: 201 },
          dotSize: { value: defaults.dotSize, min: 0, max: 1, order: 202 },
          dotSizeRand: { value: defaults.dotSizeRand, min: 0, max: 1, order: 203 },
          blur: { value: defaults.blur, min: 0, max: 1, order: 205 },
          noise: { value: defaults.noise, min: 0, max: 1, order: 205 },
          overlayX: { value: defaults.overlayX, min: 0, max: 0.5, order: 210 },
          overlayY: { value: defaults.overlayY, min: 0, max: 0.5, order: 210 },
          overlayScale: { value: defaults.overlayScale, min: 0, max: 3, step: 1, order: 210 },
        },
        { order: 1 }
      ),
