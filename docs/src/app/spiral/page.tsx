      ...
      Parameters: folder(
        {
          ...
          scale: { value: defaults.scale, min: 0, max: 3, order: 200 },
          offsetX: { value: defaults.offsetX, min: -0.5, max: 0.5, order: 201 },
          offsetY: { value: defaults.offsetY, min: -0.5, max: 0.5, order: 202 },
