      ...
      Parameters: folder(
        {
          ...
          strokeTaper: { value: defaults.strokeTaper, min: 0, max: 0.5, order: 206 },
          strokeCap: { value: defaults.strokeCap, min: 0, max: 1, order: 207 },
          noiseFreq: { value: defaults.noiseFreq, min: 0, max: 100, order: 350 },
          noisePower: { value: defaults.noisePower, min: 0, max: 0.5, order: 351 },
          blur: { value: defaults.blur, min: 0, max: 0.5, order: 352 },
