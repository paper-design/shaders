...
const StaticMeshGradientWithControls = () => {
  ...
  const [params, setParams] = useControls(() => {
    return {
      ...
      scale: { value: defaults.scale, min: 0.01, max: 4, snapPoints: [1], order: 300 },
      rotation: { value: defaults.rotation, min: 0, max: 360, order: 301 },
      offsetX: { value: defaults.offsetX, min: -1, max: 1, snapPoints: [0], order: 302 },
      offsetY: { value: defaults.offsetY, min: -1, max: 1, snapPoints: [0], order: 303 },
    };
  }, [colors.length]);
