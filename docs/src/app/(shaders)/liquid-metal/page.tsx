...
const LiquidMetalWithControls = () => {
  ...
  const [params, setParams] = useControls(() => {
    ...
    return {
      ...
      shiftRed: { value: defaults.shiftRed, min: -1, max: 1, snapPoints: [0], order: 202 },
      shiftBlue: { value: defaults.shiftBlue, min: -1, max: 1, snapPoints: [0], order: 203 },
      ...
      scale: { value: defaults.scale, min: 0.2, max: 4, snapPoints: [1], order: 301 },
