...
const PrismWithControls = () => {
  ...
  const [params, setParams] = useControls(() => {
    ...
    return {
      ...
      angle: { value: defaults.angle, min: 0, max: 90, order: 202 },
      radiality: { value: defaults.radiality, min: 0, max: 1, order: 203 },
      ...
      distortionRadiality: { value: defaults.distortionRadiality, min: 0, max: 1, order: 209 },
