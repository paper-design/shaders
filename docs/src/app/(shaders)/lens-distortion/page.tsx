...
const LensDistortionWithControls = () => {
  ...
  const [params, setParams] = useControls(() => {
    ...
    return {
      ...
      bias: { value: defaults.bias, min: -1, max: 1, snapPoints: [0], order: 101 },
      ...
      dispersionShift: { value: defaults.dispersionShift, min: -1, max: 1, snapPoints: [0], order: 106 },
      ...
      swirl: { value: defaults.swirl, min: -1, max: 1, snapPoints: [0], order: 280 },
      ...
      lensBulge: { value: defaults.lensBulge, min: -1, max: 1, snapPoints: [0], order: 400 },
      ...
      imageX: { value: defaults.imageX, min: -1, max: 1, snapPoints: [0], order: 411 },
      imageY: { value: defaults.imageY, min: -1, max: 1, snapPoints: [0], order: 412 },
      scale: { value: defaults.scale, min: 0.5, max: 4, snapPoints: [1], order: 450 },
