...
const DotGridWithControls = () => {
  const [params, setParams] = useControls(() => {
    return {
      ...
      gapX: { value: defaults.gapX, min: 2, max: 500, order: 202 },
      gapY: { value: defaults.gapY, min: 2, max: 500, order: 203 },
      strokeWidth: { value: defaults.strokeWidth, min: 0, max: 50, order: 204 },
      sizeRange: { value: defaults.sizeRange, min: 0, max: 1, order: 205 },
      opacityRange: { value: defaults.opacityRange, min: 0, max: 1, order: 206 },
