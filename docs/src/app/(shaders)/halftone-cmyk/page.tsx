...
const HalftoneCmykWithControls = () => {
  ...
  const [params, setParams] = useControls(() => {
    ...
    return {
      ...
      gridNoise: { value: defaults.gridNoise, min: 0, max: 1, step: 0.01, order: 112 },
      gridSampleNoise: { value: defaults.gridSampleNoise, min: 0, max: 1, step: 0.01, order: 113 },
      radius: { value: defaults.radius, min: 0.01, max: 1, step: 0.01, order: 122 },
      minRadius: { value: defaults.minRadius, min: 0, max: 0.2, step: 0.01, order: 123 },
      ...
      // angleM: { value: defaults.angleM, min: 0, max: 90, step: 0.1, order: 220 },
      shiftM: { value: defaults.shiftM, min: -0.5, max: 0.5, step: 0.01, order: 221 },
      // angleY: { value: defaults.angleY, min: 0, max: 90, step: 0.1, order: 230 },
      shiftY: { value: defaults.shiftY, min: -0.5, max: 0.5, step: 0.01, order: 231 },
      // angleK: { value: defaults.angleK, min: 0, max: 90, step: 0.1, order: 240 },
      shiftK: { value: defaults.shiftK, min: -0.5, max: 0.5, step: 0.01, order: 241 },
      ...
      compensationC: { value: defaults.compensationC, min: -1, max: 1,  step: 0.01, order: 105 },
      compensationM: { value: defaults.compensationM, min: -1, max: 1,  step: 0.01, order: 106 },
      compensationY: { value: defaults.compensationY, min: -1, max: 1,  step: 0.01, order: 107 },
      compensationK: { value: defaults.compensationK, min: -1, max: 1,  step: 0.01, order: 108 },
      shape: {
