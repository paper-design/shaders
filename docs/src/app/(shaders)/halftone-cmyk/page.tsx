...
const HalftoneCmykWithControls = () => {
  ...
  const [params, setParams] = useControls(() => {
    ...
    return {
      ...
      angleM: { value: defaults.angleM, min: 0, max: 90, step: 0.1, order: 120 },
      shiftM: { value: defaults.shiftM, min: -0.5, max: 0.5, step: 0.01, order: 121 },
      visibilityM: { value: defaults.visibilityM, min: 0, max: 1, step: 0.01, order: 122 },
      angleY: { value: defaults.angleY, min: 0, max: 90, step: 0.1, order: 130 },
      shiftY: { value: defaults.shiftY, min: -0.5, max: 0.5, step: 0.01, order: 131 },
      visibilityY: { value: defaults.visibilityY, min: 0, max: 1, step: 0.01, order: 132 },
      ...
      visibilityK: { value: defaults.visibilityK, min: 0, max: 1, step: 0.01, order: 142 },
