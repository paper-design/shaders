...
const HalftoneCmykWithControls = () => {
  ...
  const [params, setParams] = useControls(() => {
    ...
    return {
      ...
      rounded: { value: defaults.rounded, order: 122 },
      shape: {
      ...
      addonC: { value: defaults.addonC, min: -1, max: 1, step: 0.01, order: 200 },
      addonM: { value: defaults.addonM, min: -1, max: 1, step: 0.01, order: 201 },
      addonY: { value: defaults.addonY, min: -1, max: 1, step: 0.01, order: 202 },
      addonK: { value: defaults.addonK, min: -1, max: 1, step: 0.01, order: 203 },
      boostC: { value: defaults.boostC, min: -1, max: 1, step: 0.01, order: 210 },
      boostM: { value: defaults.boostM, min: -1, max: 1, step: 0.01, order: 211 },
      boostY: { value: defaults.boostY, min: -1, max: 1, step: 0.01, order: 212 },
      boostK: { value: defaults.boostK, min: -1, max: 1, step: 0.01, order: 213 },
