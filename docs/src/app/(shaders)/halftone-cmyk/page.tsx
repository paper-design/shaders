...
const HalftoneCmykWithControls = () => {
  ...
  const [params, setParams] = useControls(() => {
    ...
    return {
      ...
      addonC: { value: defaults.addonC, min: -1, max: 1, step: 0.01, order: 210 },
      addonM: { value: defaults.addonM, min: -1, max: 1, step: 0.01, order: 211 },
      addonY: { value: defaults.addonY, min: -1, max: 1, step: 0.01, order: 212 },
      addonK: { value: defaults.addonK, min: -1, max: 1, step: 0.01, order: 213 },
      ...
      boostK: { value: defaults.boostK, min: -1, max: 1, step: 0.01, order: 203 },
