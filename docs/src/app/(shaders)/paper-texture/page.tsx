...
const PaperTextureWithControls = () => {
  ...
  const [params, setParams] = useControls(() => {
    ...
    return {
      ...
      crumpleSoftness: { value: defaults.crumpleSoftness, min: 0, max: 1, order: 322 },
      test: { value: defaults.test, min: 0, max: 1, order: 325 },
      testSize: { value: defaults.testSize, min: 0, max: 1, order: 326 },
      testLayers: { value: defaults.testLayers, min: 1, max: paperTextureMeta.maxTestLayers, step: 1, order: 327 },
      testDensity: { value: defaults.testDensity, min: 0, max: 1, order: 328 },
      testSoftness: { value: defaults.testSoftness, min: 0, max: 1, order: 329 },
