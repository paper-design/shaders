...
const PaperTextureWithControls = () => {
  ...
  const [params, setParams] = useControls(() => {
    ...
    return {
      ...
      creaseSizeX: { value: defaults.creaseSizeX, min: 0, max: 1, order: 236 },
      creaseSizeY: { value: defaults.creaseSizeY, min: 0, max: 1, order: 237 },
      creaseOffsetX: { value: defaults.creaseOffsetX, min: -0.5, max: 0.5, order: 238 },
      creaseOffsetY: { value: defaults.creaseOffsetY, min: -0.5, max: 0.5, order: 239 },
