...
const PaperTextureWithControls = () => {
  ...
  const [params, setParams] = useControls(() => {
    ...
    return {
      ...
      drops: { value: defaults.drops, min: 0, max: 1, order: 240 },
      fade: { value: defaults.fade, min: 0, max: 1, order: 250 },
      seed: { value: defaults.seed, min: 0, step: 1, max: 1000, order: 251 },
